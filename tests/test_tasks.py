...
#    @unittest.skip('skipping test_fhelp')
    def test_fhelp(self):
        """
...
#    @unittest.skip('skipping test_fhelp_pos_arg')
    def test_fhelp_pos_arg(self):
        """
        Test the fhelp program by retrieving the help for ftlist.
        """
...
#    @unittest.skip('skipping test_fthelp_pos_arg')
    def test_fthelp_pos_arg(self):
        """
        Test the fthelp program by retrieving the help for ftlist.
        """
        help_out = heasoftpy.fthelp('ftlist')
        #string_out = byte_out.decode()
        test_out = []
        for test_line in help_out.stdout.split('\n'):
            test_out.append(test_line)
...
#    @unittest.skip('skipping test_ftcopy')
...
#    @unittest.skip('skipping test_fthelp')
...
#    @unittest.skip('skipping test_ftlist')
...
#    @unittest.skip('skipping test_ftlist_dot_output')
    ...
    #@unittest.skip('skipping test_ftstat')
    ...
    #@unittest.skip('Skipping test_ftverify')
...
#    @unittest.skip('Skipping test_ftverify_single_arg')
