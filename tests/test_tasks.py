...
class TestPyTasks(unittest.TestCase):
    ...
    def test__tasks__flistC(self):
        ...
        self.assertEqual(out[3], ('    1 TIME               D [d]       '
                                  '         label for field   1'))
        self.assertEqual(out[4], ('    2 RATE               E [counts/s]'
                                  '         label for field   8'))
        self.assertEqual(out[5], ('    3 ERROR              E [counts/s]'
                                  '         label for field   9'))
    ...
    def test__tasks__flistT(self):
        ...
        self.assertEqual(out[0], ('       1164.29445392592        18.2019'
                                  '        1.22564'))
        self.assertEqual(out[1], ('       1164.43056492592        16.3479'
                                  '        1.38458'))
        self.assertEqual(out[2], ('       1164.43167642593        17.2304'
                                  '        1.48210'))
    ...
    def test__tasks__fdump(self):
        ...
        self.assertEqual(out[1], ('BITPIX  =                    8 / '
                                  'number of bits per data pixel'))
        self.assertEqual(out[2], ('NAXIS   =                    0 / '
                                  'number of data axes'))
    ...
    def test__tasks__page_no__noquery_more(self):
        # first page=yes, 'more' will be queryied (i.e. raise ValueError in
        # the simulated input)
    ...
    # ensure empty strings are passed correctly with subprocess
