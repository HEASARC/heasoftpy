...
HSPParam = heasoftpy.core.HSPParam
HSPTask = heasoftpy.core.HSPTask
HSPTaskException = heasoftpy.core.HSPTaskException
...
class TestPFile(unittest.TestCase):
    ...
    def test__find_pfile__noHeadas(self):
        ...
        with self.assertRaises(HSPTaskException):
...
class TestWritePFile(unittest.TestCase):
    ...
    def test__write_pfile__mode_q(self):
        ...
        wTxt = (
         'par1,s,a,,,,"Par1"\npar2,r,q,2.0,,,"Par2"\npar3,r,h,3.0,,,"Par3"\n'
         'par4,r,ql,4.0,,,"Par4"\npar5,r,hl,5.0,,,"Par5"\nmode,s,h,"q",,,')
        with open(f'{taskname}.par', 'w') as fp:
            fp.write(wTxt)
        # --- #
...
class TestHSPParam(unittest.TestCase):
    ...
    def test_HSPParam__eq_HSPParam(self):
        ...
        class HSPtmp:
            par = HSPParam(line)
        hspinst = HSPtmp()
        self.assertEqual(hspinst.par, HSPParam(line))
